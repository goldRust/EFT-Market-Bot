...
def gui_man():
    start = gui('Tarkov Market Tool', showIcon=False)
    start.addButton('Start',main)
    start.addButton('2560x1440',set_fourteenforty)
    start.addButton('1920x1080',set_teneighty)
    start.go()
